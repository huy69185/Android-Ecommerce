...
public class ProductModel implements Serializable {
    ...
    private double originalPrice, discount, price;
    ...
    public ProductModel(String name, List<String> searchKey, String image, String category, String description, String specification, double originalPrice, double discount, double price, int productId, int stock, String shareLink, float rating, int noOfRating) {
        this.name = name;
