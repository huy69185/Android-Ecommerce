...
public class ModifyProductActivity extends AppCompatActivity {
    ...
    private void initProduct(ProductModel p) {
        ...
        priceEditText.setText(String.format("%.2f", currProduct.getOriginalPrice()));
        discountEditText.setText(String.format("%.2f", currProduct.getDiscount()));
    }
    ...
    void updateDataToFirebase() {
        if (!nameEditText.getText().toString().equals(currProduct.getName())) {
            ...
            FirebaseUtil.getProducts().document(docId).update("searchKey", Arrays.asList(nameEditText.getText().toString().trim().toLowerCase().split(" ")));
        }
        ...
        if (!priceEditText.getText().toString().equals(String.format("%.2f", currProduct.getOriginalPrice()))) {
            double originalPrice = Double.parseDouble(priceEditText.getText().toString());
            ...
            FirebaseUtil.getProducts().document(docId).update("price", originalPrice - discount);
        }
        if (!discountEditText.getText().toString().equals(String.format("%.2f", currProduct.getDiscount())))
            FirebaseUtil.getProducts().document(docId).update("discount", Double.parseDouble(discountEditText.getText().toString()));
    }
